...
- [x] 적절하지 않은 인풋이 입력될 경우, Alert 표시

#### 0-2. 회원가입 페이지

- [x] 사용자의 아이디와 비밀번호를 입력받는 기능
- [x] 비밀번호가 적절한지 판별하는 기능
- [x] 사용가능한 아이디인지 판별하는 기능
- [x] 사용자 연락처 입력 기능
- [x] 문자메세지로 인증번호 발급 기능
- [x] 닉네임 입력 기능
- [x] 닉네임 중복 판별 기능
...
- [x] 보호자 -> 시니어 알람 생성 기능
- [x] 보호자가 관리하는 시니어 알람 UI (BE API 수정중)
- [x] 보호자가 관리하는 시니어 알람 수정
