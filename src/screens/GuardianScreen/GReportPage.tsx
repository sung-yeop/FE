...
import GReportSelectMisson from '../../components/Guardian/GReportPageComponents/GReportSelectMisson';
...
const GReportPage = () => {
  ...
  const [isClickSelectSeniorBtn, setIsClickSelectSeniorBtn] =
  ...
  >();
  const {current, updateCurrentMission, updateCurrnetUsername} =
    useGuardianReportManager();
  ...
  useEffect(() => {
    if (current.username) {
      setIsClickSelectSeniorBtn(true);
          ...
          {!isClickReportBtn && (
            <Animated.View style={{opacity: fadeAnim1}}>
              <SelectUser
                ...
                updateCurrnetUsername={updateCurrnetUsername}
              />
            </Animated.View>
          )}
          {isClickSelectSeniorBtn && (
            <Animated.View
              style={{
              ...
              <View style={styles.ViewContent}>
                <Animated.View style={{opacity: fadeAnim1}}>
                  <GReportSelectMisson current={current} />
                </Animated.View>
